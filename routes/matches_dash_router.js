...
router.post('/fetch_matches', async (req, res) => {
    ...
    // console.log(match_info[0].title)
    // console.log(match_info[0].team1)
    // console.log(match_info[0].team2)
    console.log(team_details[0].color)
    console.log(team_details[0].name)
